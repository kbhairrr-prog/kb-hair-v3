...
export const metadata: Metadata = { title: 'Mouvements stock — KB Hair Admin' };
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <h1 className="font-display text-2xl text-white italic font-light">Mouvements stock</h1>
      </div>
